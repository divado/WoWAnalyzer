import { Divado } from 'CONTRIBUTORS';
...
const config: Config = {
  ...
  exampleReport: "/report/Dcavb6xXM7pTr2J8/10-Normal+Anub'arak+-+Kill+(1:59)/Enutrof",
  // Add spells to display separately on the timeline
  timeline: {
    separateCastBars: [[]],
  },
  // The current spec identifier. This is the only place (in code) that specifies which spec this parser is about.
  spec: SPECS.CLASSIC_PRIEST_DISCIPLINE, // UPDATE THIS
